$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/popoffvg/Library/Application Support/carapace/bin" } | prepend "/Users/popoffvg/Library/Application Support/carapace/bin")
