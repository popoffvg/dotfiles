...
│   └── !archived/adr/                ← superseded and deprecated ones
├── src/
│   ├── ordering/
│   │   ├── CONTEXT.md
...
If any of the three is missing, skip the ADR. Use the format in [ADR-FORMAT.md](./ADR-FORMAT.md) and start from [ADR-TEMPLATE.md](./ADR-TEMPLATE.md).
