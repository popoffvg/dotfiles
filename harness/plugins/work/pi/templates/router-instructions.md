...
- A worktree is created automatically by `/work:start`. If `worktreePath` is set in settings, make all code changes there. Otherwise work in the current directory.
