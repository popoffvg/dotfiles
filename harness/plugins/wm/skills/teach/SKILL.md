...
| `MISSION.md` | Why the human is learning this code. Every lesson traces back to it. | `examples/teach-mission.md` |
| `RESOURCES.md` | The trusted sources — the code first, external docs second. | `examples/teach-resources.md` |
| `learning-records/NNNN-*.md` | What the human understood in one session, and the level the next one starts at. | `examples/teach-learning-record.md` |
