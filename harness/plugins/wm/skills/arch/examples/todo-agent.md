...
> order and the shape of each increment; the rules that govern them are `arch:sub-todo.md`
> § Section rules, and the element list and order are its § Required elements.
