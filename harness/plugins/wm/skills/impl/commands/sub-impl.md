...
3. **Start** — set the TODO frontmatter `status: todo → impl`. Leave `increment` alone: step 5.5 owns it, and raising it here claims an increment the commit does not hold.
