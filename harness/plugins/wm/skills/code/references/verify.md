...
This is a **blocking** check. A failing E-category turns the result to NEEDS REVISION with `Required spec edits` listing exactly which TODOs need a real manual or integration step.
