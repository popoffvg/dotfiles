...
5. **Commit** — on green, commit per `references/commit.md`. The spec's `## Commit` block is the primary message.
6. **Report** — state what shipped, the test command + its real output, and stop. One TODO per invocation.
