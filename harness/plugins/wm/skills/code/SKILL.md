...
| `teach` | Build **the human's** understanding of the codebase and the branch change, step by step across sessions. Stateful workspace `<notes-dir>/teach/` — mission, HTML lessons, reference sheets, learning records. Read-only over source. | `sub:teach.md` · `tpl:teach-mission.md` · `tpl:teach-learning-record.md` · `tpl:teach-resources.md` · `skill:lessons` |
