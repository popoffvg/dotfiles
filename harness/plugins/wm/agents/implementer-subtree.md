...
Follow the `code` skill (`${CLAUDE_PLUGIN_ROOT}/skills/code/SKILL.md`) for the implementation contract. The rules below are the agent-level constraints for the worktree (`wt`-backed create + merge) flow.
