...
// modes.json lives at plugin-root common/mode-scope/ (shared config).
// __dirname here is common/pi/modules/, so go up two levels.
const CONFIG_FILE = join(__dirname, "..", "..", "common", "mode-scope", "modes.json");
