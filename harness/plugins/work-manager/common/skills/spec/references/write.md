...
- `<notes-dir>/spec.md` contains: Description, Terms, Implementation Guidelines, Goal, Design Decisions, **TODO List**. The TODO List is an index — `TODO-N: <outcome>` pairs only, **no bodies**.
