...
`<notes-dir>` is the work-manager notes directory for the current task (commonly `.notes/`). Resolve it from the active phase context; do not hardcode `.notes/` inside this skill.
