...
Deep pruning of an existing skill or corpus — the cross-file dedup map, the property and block tests, the reshape pass — is the `prune-text` skill's job. Run it on a skill that has grown sediment.
