#!/usr/bin/env python3
"""Find which line of a file matches an line-comment anchor hash.

The line-comment language server anchors each comment to a line number plus a hash:
...
usage: line-comment-find-anchor.py <file> <hash>...
       line-comment-find-anchor.py --store <line-comment.json> [<root>]
